...
export class SeoV2Service {
  ...
  public setTitle(title: string) {
    ...
    const oldTitle = lang == "ar" ? "King Food " : " King Food ";
    this._Meta.updateTag({
      name: "title",
      property: "og:title",
  ...
  public setMetaImage(imge: string) {
    // const url = "https://king-food.eu"+imge
  ...
  updateDefaultSeo() {
    ...
    this._Meta.addTags([
      ...
      },
      {
        name: "keywords",
        property: "schema:keywords",
        content: `King Food , رؤية 2030, توظيف التقنية, تسهيل الحياة, الأفراد, القطاعات غير الحكومية, السعودية, تقنية المستقبل, تطوير الخدمات`,
      },
      {
        name: "robots",
        content:
      ...
      { property: "og:url", content: "https://king-food.eu/" },
      ...
      // { name: 'msapplication-square70x70logo', content: 'https://king-food.eu/assets/images/SehatyLogo/Sehaty_Logo_70x70.png' },
      // { name: 'msapplication-square150x150logo', content: 'https://king-food.eu/assets/images/SehatyLogo/Sehaty_Logo_150x150.png' },
      // { name: 'msapplication-wide310x150logo', content: 'https://king-food.eu/assets/images/SehatyLogo/Sehaty_Logo_310X150.png' },
      // { name: 'msapplication-square310x310logo', content: 'https://king-food.eu/assets/images/SehatyLogo/Sehaty_Logo_310X310.png' }
    ]);
  }
}
